...
var hdelk = (function(){
    ...
    var node_highlight_name_text_color = ['#DDD', '#222', '#46C', '#922', '#A90', '#350', '#922061', '#B97AFF', '#0C0FF8'];
    ...
    var edge_label_highlight_fill_color = ['#DDD', '#222', '#46C', '#922', '#A90', '#350', '#922061', '#B97AFF', '#0C0FF8'];

    var edge_width = 1;
    var edge_color = '#888';
    var edge_highlight_color = ['#DDD', '#444', '#06d', '#C00', '#980', '#590', '#C40070', '#AD60FF', '#7579FF'];
